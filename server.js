...
const youtube = new YouTube("AIzaSyDSIYNJjwfCMQh95rEmDxwQold8cwQljWk"); //تعديل اساسي سوي اي بي اي جديد
...
client.on("message", message => {
  if (message.content === prefix + "bot") {
    const bot = new Discord.RichEmbed()
      ...
      .addField("**Bot Owner** :  ", `» <@729375829876015176>`, true) // تعديل اساسي غير الايدي لايدي حسابك
      .setImage("")
